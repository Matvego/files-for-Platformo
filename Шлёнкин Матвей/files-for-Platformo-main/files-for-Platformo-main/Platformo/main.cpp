...
int change_gamelevel(Platforma platforma[], int gamelevel)
{
    ...
    {
        count_platform = 5 ;
        platforma[0] = {-50,550,400,200,txLoadImage("Platforma.bmp"), 0,0,0, platforma[0].y,200,100};
        platforma[1] = {300,550,400,200,txLoadImage("Platforma.bmp"), 0, 0,0, platforma[1].y,200,100};
        platforma[2] = {550,210,400,200,txLoadImage("PlatformaDvig.bmp"), 1,0,0, platforma[2].y, 200, 100};
        platforma[3] = {850,550,400,200,txLoadImage("Platforma.bmp"), 0,0,0, platforma[3].y,200,100};
        platforma[4] = {1250,550,400,200,txLoadImage("Platforma.bmp"), 0,0,0, platforma[4].y,200,100};
...
Vrag1 vrag1 = {550,160,250,50,5, txLoadImage("AnimathionVrag1R.bmp"),
